...
const iconNames = [
  ...
  'ArrowUp', 'ArrowUpRight', 'Award', 'Ban', 'Banknote', 'BarChart3', 'Barcode',
  'Bell', 'BookOpen', 'Briefcase', 'Building2', 'Calculator', 'Calendar',
  ...
  'Filter', 'Gavel', 'Gem', 'Gift', 'Globe', 'GripVertical', 'Hammer', 'Hash',
  'Heart', 'HelpCircle', 'Home', 'Image', 'IndianRupee', 'Info', 'Key', 'Landmark',
  ...
  'PanelRight', 'Pause', 'Pencil', 'Percent', 'Phone', 'Play', 'Plus', 'Printer',
  ...
  'Smartphone', 'Star', 'Store', 'Table', 'Tag', 'Target', 'Terminal', 'ToggleLeft',
